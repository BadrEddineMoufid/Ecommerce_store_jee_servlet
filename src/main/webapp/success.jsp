<%@page import="com.badr.Ecommerce_store_JEE.beans.Product"%>
	...
	<c:choose>
		...
		<c:when test="${session != null}">
				...
				<div class="container" style="margin-top: 60px;margin-bottom: 60px;">
					...
					<!-- Note that this is jut a demo no email will be sent Wabba lubba dub dub -->
					<p>Note: No email will be send this is just a demo </p>
				</div>
