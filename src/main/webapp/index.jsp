	...
	<header>
		<h1>
			...
			<!--
				...
				You realize that nighttime makes up half of all time?-Rick
			-->
		</h1>
		<nav>
			<ul>
				<li><a href="Controller?page=index">Home</a></li>
				<!--check if logged in or not and display appropriate links bananaaaa hmmm -->
 	...
 	<div class="container">
 		<div class="row">
 				...
 				<div class="col-md-8"><!-- right -->
					...
					<select name="sort" class="form-controle">
						<option value="low-to-high">Low to high</option>
						<option value="high-to-high">high to low</option>
					</select>
					<input class="btn btn btn-info" type="submit" value="Go!">
					</form>

					<!--
						To live is to risk it all; otherwise you're just an inert chunk of
						randomly assembled molecules drifting wherever the universe blows you.- Rick
						-->
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getFeatured() == 'yes' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<p style="text-align: center;"><c:out value="${ product.getPrice() }"></c:out> MAD</p>
