...
<sql:setDataSource user="root" password="falcon" driver="com.mysql.cj.jdbc.Driver"
                   url="jdbc:mysql://localhost:3306/jee_project" var="ds"/>
        ...
        <table style="table-layout: fixed;width: 100%;">
            ...
            <tr>
                ...
                <td style="width: 100px;">
                    <img src="${row.image}" height="100" width="150">
                </td>
